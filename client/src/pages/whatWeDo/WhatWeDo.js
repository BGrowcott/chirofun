            ...
            text: {
                p1: (
                    <div>
                        <div className="fs-4">
                            <p>
                                <strong>Chiropractors</strong> are best known for manual treatments such as spinal manipulation, where they use their hands to free stiff or restricted joints, or
                                mobilisation, which is the gradual moving of joints.
                            </p>
                        </div>
                        <p>
                            They may also use other recommended treatments such as certain types of acupuncture, electrotherapy, stretching exercises, and rehabilitation, all of which form part of a
                            chiropractor's <em>package of care</em>. Your chiropractor may also offer lifestyle advice to help recovery and prevent repeated episodes of back pain.
                        </p>
                    </div>
                ),
                p2: (
                    <div>
                        ...
                        <p>
                            The title <strong>Chiropractor</strong> is statutorily regulated and thus protected by law. This means that Chiropractors must be registered with The General Chiropractic
                            Council.
                        </p>
                        <div>
            ...
            text: {
                ...
                p2: (
                    <div>
                        ...
                        <p>
                            We aim to make all our treatments affordable for patients. Please enquire about our full range of treatments and competitive pricing.{" "}
            ...
            text: {
                p1: (
                    <div>
                        <div className="fs-4">
                            <p>
                                <strong>Injections, or IV Vitamin Therapy</strong>, involves delivering micronutrients directly into the bloodstream for superior and more complete absorption
                                (bypassing the gut). Treat deficiencies and detoxification, reduce inflammation, boost energy levels and reduce fatigue, enhance immune system function, and improve
                ...
                p2: (
                    <div>
                        <div>
                            ...
                            <p>
                                Glutathione booster injections are a powerful antioxidant therapy designed to promote detoxification, improve skin health & enhance overall wellness. Glutathione,
                                called the "master antioxidant" helps neutralise free radicals, reduce oxidative stress & support the body's natural detoxification process.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                A powerful therapy to strengthen the immune system, improve skin health & combat oxidative stress. This vital antioxidant, supports collagen production, boosts energy
                                levels & fights off infection.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                For combination injection therapy, it's not necessary to book separately. You can request your preference when using the online booking system for one of the single
                                injection therapies or call us to book.
                            </p>
                        </div>
                    </div>
                ),
            ...
            text: {
                p1: (
                    <div>
                        <div className="fs-4">
                            <p>
                                Along with Chiropractic, <strong>Yoga</strong> is recommended by the National Institute of Clinical Excellence as part of a first basis approach to Back Pain care.
                            </p>
                        </div>
                    </div>
                ),
                p2: (
                    <div>
                        <p>
                            Claire came to yoga after years of back pain. The yoga practice helped with the back pain, but the mindfulness and inner calm kept Claire interested and coming back for
                            more. Claire teaches at various studios across Birmingham and offers online/in-person 1-2-1s.
                        </p>
                        <p>
                            In a 1-2-1 session, we will examine how yoga techniques can support your current treatment with Birmingham Chiropractic. We will explore how you can improve flexibility,
                            mobility, posture, and increasing strength.
                        </p>
                        <p>You can also book a 1-2-1 to help with meditation/mindfulness or to prepare you for attending a class at a yoga studio. Please call to book.</p>
                    </div>
                ),
            },
        ...
        },
        {
            ...
            text: {
                p1: (
                    <div>
                        <p className="fs-4">
                            <strong>Sports massage</strong> is a specialised form of massage therapy aimed at active individuals to help prevent injuries, improve performance, and facilitate faster
                            recovery.
                        </p>
                        <p>
                            However, sports massage is for more than just the active sportsperson. Whether you are a stay-at-home parent, have an office-based job, or are a manual worker, we provide
                            practical and beneficial treatment for all individuals.
                        </p>
                        <p>
                            We will aim to correct problems and imbalances in soft tissue structures caused by trauma, repetitive movements or physical activity using various massage techniques. In
                            doing so, we bring clients back to the optimal levels of functional, occupational and sports-specific fitness - regardless of age and ability.
                        </p>
                    </div>
                ),
                p2: (
                    <div>
                        <p>
                            The benefits of sports massage go beyond simple relaxation: Reduced muscle tension, improved circulation, injury prevention, improved recovery, pain management, enhanced
