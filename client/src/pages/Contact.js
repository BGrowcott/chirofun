        ...
        <section className=" border-top border-1 border-secondary">
            <div className="container">
                <div className="p-md-3">
                    ...
                    <div className="p-3 mt-1 bg-warm">
                        <div className="row">
                            ...
                            <div className="col-12 col-md-6 mb-5 mb-md-0">
                                <div className="p-3 h-100 white-border shadow" style={{ backgroundColor: "#F0EFEF" }}>
                                    ...
                                    <p className="fs-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum commodo libero consequat sapien egestas malesuada eget eu quam.</p>
                                </div>
                            </div>
                            <div className="col">
                                <div className="p-3 h-100 white-border shadow" style={{ backgroundColor: "#F0EFEF" }}>
