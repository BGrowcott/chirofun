...
function Hero() {
	return (
		<section className="hero position-relative mb-5">
			<div className="hero-img" style={{ backgroundImage: `url(${hero2})` }}></div>
			<div className="container-fluid p-0">
				<div className="row">
					<div
						...
						style={{
							height: "70vh",
							backgroundImage: "linear-gradient(to right, #ffffffc2 35%, transparent)",
						}}
					>
						<div className="row h-100 d-flex align-items-md-center">
							<div className="p-5 col-12 col-md-8 col-xxl-7 d-flex flex-column justify-content-between">								
									<div>
										...
										<p className="fs-3 d-none d-lg-block">Outstanding back and neck care.</p>
										<p className="fs-5 d-none d-lg-block">
											We strive to get you pain-free using safe, evidence-based, and individually tailored treatment programs.
											<span className="fw-bold">We want you back to doing what you love.</span>
										</p>
									</div>
									<div>
										<a
